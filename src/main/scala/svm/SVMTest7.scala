...
object SVMTest7 {
	...
	def main(args: Array[String]): Unit = {
		...
		val parsedRDD = sc.textFile("file:///e:/svm/svm4.txt").map {
			x =>
				val data = x.split(",")
		...
		val Array(training1, test1) = msgDF.randomSplit(Array(0.8, 0.2), seed = 132L)

		val model = getModel1(training1)
		model.save("file:///e:/svm/tfidfModel1/")
		//向量化语料集
		...
		smodel1.save(sc,"file:///e:/svm/svmModel1/")
