...
public class PolarServerOneJabbr extends Thread {
    ...
    public PolarServerOneJabbr(Socket s, PipelineModel tfidf1, PipelineModel tfidf2, SVMModel svm1, SVMModel svm2) {
        socket = s;
        tfidfModel1 = tfidf1;
        tfidfModel2 = tfidf2;
    ...
    private List<String> dataUtil(String str) {
        ...
        for (String s : strs) {
            String result = LoadModel.pric2(s, tfidfModel1, tfidfModel2, svmModel1, svmModel2);
            list.add(result);
        }
        return list;
    }
